            ...
            <div class="flex justify-start items-center">
                <form action="{{ route('dosen.update', $dosen->id) }}" method="POST">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <!-- Input untuk NIDN -->
                        <input type="text" id="nidn" name="nidn" value="{{ $dosen->nidn }}" required class="bg-white w-72 h-16 text-black font-balsamiq p-4 focus:outline-blue-500">
                    </div>
                    ...
                    <div class="flex items-center space-x-3 mt-6">
                        ...
                        <input type="text" id="nama_dosen" name="nama_dosen" value="{{ $dosen->nama_dosen }}" required class="bg-white w-72 h-16 text-black font-balsamiq p-4  focus:outline-blue-500">
                    </div>
                    ...
                    <div class="flex items-center space-x-3 mt-6">
                        ...
                        <!-- Input untuk no hp -->
                        <input type="text" id="no_hp" name="no_hp" value="{{ $dosen->no_hp }}" required  class="bg-white w-72 h-16 text-black font-balsamiq p-4  focus:outline-blue-500">
                    </div>
