    ...
    <section>
        ...
        <div class="flex justify-end mt-2 items-center">
            ...
            <div id="circleButton" class="bg-[#3687FF] hover:bg-opacity-80 w-14 h-14 rounded-full ml-6 flex items-center justify-center cursor-pointer transition duration-300 active:ring-2">
                <a href="{{ route('mahasiswa.create') }}" title="Tambah" class="flex items-center justify-center w-full h-full">
            ...
            <table class="datatable border border-slate-700 w-full m-2">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border border-slate-700 p-2 text-center">{{ $mahasiswa->nim }}</td>
                            <td class="border border-slate-700 p-2 text-center">{{ $mahasiswa->nama_mahasiswa }}</td>
                            <td class="border border-slate-700 p-2 text-center">{{ $mahasiswa->jenis_kelamin }}</td>
                            <td class="border border-slate-700 p-2 text-center">{{ $mahasiswa->no_hp }}</td>
